...
$BackendCommand = "`$env:PYTHONPATH='backend/agentgrid-backend'; `$env:DATABASE_URL='postgresql://postgres:postgres@localhost:5435/agentgrid'; & '$BackendVenv' -m uvicorn app.main:app --host 0.0.0.0 --port 8000 --reload"
